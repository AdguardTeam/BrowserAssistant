...
export const WORKING_STATES = {
    APP_IS_NOT_INSTALLED: 'IS_APP_INSTALLED',
    APP_IS_NOT_RUNNING: 'IS_APP_RUNNING',
    APP_IS_NOT_UP_TO_DATE: 'IS_APP_UP_TO_DATE',
    EXTENSION_IS_NOT_UPDATED: 'IS_EXTENSION_UPDATED',
    EXTENSION_IS_RELOADING: 'IS_EXTENSION_RELOADING',
    PROTECTION_IS_NOT_ENABLED: 'IS_PROTECTION_ENABLED',
};
