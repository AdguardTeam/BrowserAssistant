...
// eslint-disable-next-line func-names
        ...
        /***/ (function(module) {
            ...
            module.exports = JSON.parse("{\"a\":\"4.3.25\"}");
...
// CONCATENATED MODULE: ./src/localization.js
            function localization_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { localization_typeof = function _typeof(obj) { return typeof obj; }; } else { localization_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return localization_typeof(obj); }
...
// CONCATENATED MODULE: ./src/adguard-selector.js
            function adguard_selector_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { adguard_selector_typeof = function _typeof(obj) { return typeof obj; }; } else { adguard_selector_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return adguard_selector_typeof(obj); }
...
// CONCATENATED MODULE: ./src/iframe.mobile.js
            ...
            function iframe_mobile_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { iframe_mobile_ownKeys(source, true).forEach(function (key) { iframe_mobile_defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { iframe_mobile_ownKeys(source).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
