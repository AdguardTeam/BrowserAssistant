/******/ export function initAssistant() {
    ...
    */
        ...
        /***/ (function (module) {
            ...
            module.exports = JSON.parse("{\"settings_position_save\":\"Webseiten\",\"settings_position_save_all\":\"Alle Webseiten\",\"settings_position_save_this\":\"Diese Webseite\",\"assistant_select_element_start\":\"Starten\",\"assistant_select_element_text\":\"Wählen Sie ein zu blockierendes Element auf der Seite aus. Laden Sie die Seite neu, um den Blockiermodus zu verlassen.\",\"menu_filtration_status\":{\"message\":\"Auf dieser Webseite filtern\"},\"menu_do_not_filter_30_sec\":{\"message\":\"Für 30 Sekunden nicht blockieren\"},\"menu_block_ad_on_site\":{\"message\":\"Werbung auf dieser Seite blockieren\"},\"menu_report_abuse\":{\"message\":\"Diese Webseite melden\"},\"menu_site_report\":{\"message\":\"Webseiten-Sicherheitsbericht\"},\"menu_settings\":{\"message\":\"Assistenten-Einstellungen\"},\"menu_wot_reputation_indicator\":{\"message\":\"Website-Reputations-Indikator\"},\"menu_wot_reputation_confidence_level\":{\"message\":\"Reputationsvertrauensgrad\"},\"assistant_select_element\":{\"message\":\"Element-Blockierung\"},\"assistant_select_element_ext\":{\"message\":\"Wählen Sie ein zu blockierendes Element auf der Seite aus\"},\"assistant_select_element_cancel\":{\"message\":\"Abbrechen\"},\"assistant_block_element\":{\"message\":\"Element-Blockierung\"},\"assistant_block_element_explain\":{\"message\":\"Anpassen der Regel der Element-Blockierung\"},\"assistant_slider_explain\":{\"message\":\"Bewegen Sie den Schieberegler, um die Ausmaßgröße der neuen Regeln zu ändern:\"},\"assistant_slider_min\":{\"message\":\"Minimal\"},\"assistant_slider_max\":{\"message\":\"Maximal\"},\"assistant_extended_settings\":{\"message\":\"Erweiterte Einstellungen\"},\"assistant_apply_rule_to_all_sites\":{\"message\":\"Regel auf alle Webseiten anwenden\"},\"assistant_block_by_reference\":{\"message\":\"Durch Referenzlink blockieren\"},\"assistant_block_similar\":{\"message\":\"Ähnliche Elemente blockieren\"},\"assistant_another_element\":{\"message\":\"Ein anderes Element wählen\"},\"assistant_preview\":{\"message\":\"Vorschau\"},\"assistant_block\":{\"message\":\"Blockieren\"},\"assistant_settings\":{\"message\":\"Assistenten-Einstellungen\"},\"assistant_preview_header\":{\"message\":\"Element-Blockierung - Vorschau\"},\"assistant_preview_header_info\":{\"message\":\"Prüfen Sie, ob das Element blockiert ist\"},\"assistant_preview_end\":{\"message\":\"Vorschau beenden\"},\"wot_unknown_description\":{\"message\":\"Der Ruf dieser Webseite wird nicht durch $1 festgelegt\"},\"wot_bad_description\":{\"message\":\"Diese Webseite hat einen sehr schlechten Ruf laut $1\"},\"wot_poor_description\":{\"message\":\"Diese Webseite hat einen schlechten Ruf laut $1\"},\"wot_unsatisfactory_description\":{\"message\":\"Diese Webseite hat einen schlechten Ruf laut $1\"},\"wot_good_description\":{\"message\":\"Diese Webseite hat einen guten Ruf laut $1\"},\"wot_excellent_description\":{\"message\":\"Diese Webseite hat einen exzellenten Ruf laut $1\"},\"settings_choose_size_and_position\":{\"message\":\"Anpassen der Größe und Position des AdGuard-Assistenten\"},\"settings_icon_size\":{\"message\":\"Symbol-Größe:\"},\"settings_small\":{\"message\":\"Klein\"},\"settings_big\":{\"message\":\"Groß\"},\"settings_position\":{\"message\":\"Position:\"},\"settings_left_top\":{\"message\":\"Oben links\"},\"settings_right_top\":{\"message\":\"Oben rechts\"},\"settings_left_bottom\":{\"message\":\"Unten links\"},\"settings_right_bottom\":{\"message\":\"Unten rechts\"},\"settings_cancel\":{\"message\":\"Abbrechen\"},\"settings_save\":{\"message\":\"Änderungen speichern\"}}");
        ...
        /***/ (function (module) {
            ...
            module.exports = JSON.parse("{\"settings_position_save\":\"אתרי אינטרנט\",\"settings_position_save_all\":\"כל האתרים\",\"settings_position_save_this\":\"האתר הזה\",\"assistant_select_element_start\":\"התחל\",\"assistant_select_element_text\":\".בחר אלמנט בדף לחסימה .רענן את הדף כדי לבטל את מצב חסימת האלמנטים\",\"menu_filtration_status\":{\"message\":\"סינון באתר זה\"},\"menu_do_not_filter_30_sec\":{\"message\":\"אל תסנן כ- 30 שניות\"},\"menu_block_ad_on_site\":{\"message\":\"חסום פרסומת באתר זה\"},\"menu_report_abuse\":{\"message\":\"דווח על האתר\"},\"menu_site_report\":{\"message\":\"דיווח אבטחת אתר\"},\"menu_settings\":{\"message\":\"הגדרות העוזר האישי\"},\"menu_wot_reputation_indicator\":{\"message\":\"אינדיקטור למוניטין של אתרים\"},\"menu_wot_reputation_confidence_level\":{\"message\":\"רמת אמון מוניטין\"},\"assistant_select_element\":{\"message\":\"חוסם אלמנט\"},\"assistant_select_element_ext\":{\"message\":\"בחר אלמנט בדף לחסימה\"},\"assistant_select_element_cancel\":{\"message\":\"בטל\"},\"assistant_block_element\":{\"message\":\"חסימת אלמנט\"},\"assistant_block_element_explain\":{\"message\":\"התאם כלל חסימת אלמנט\"},\"assistant_slider_explain\":{\"message\":\":הזז את המחוון כדי לשנות את גודל המסגרת בה יעבוד הכלל החדש\"},\"assistant_slider_min\":{\"message\":\"מינימום\"},\"assistant_slider_max\":{\"message\":\"מקסימום\"},\"assistant_extended_settings\":{\"message\":\"הגדרות מתקדמות\"},\"assistant_apply_rule_to_all_sites\":{\"message\":\"החל את הכלל על כל האתרים\"},\"assistant_block_by_reference\":{\"message\":\"חסום הפניית קישור\"},\"assistant_block_similar\":{\"message\":\"חסום דומה\"},\"assistant_another_element\":{\"message\":\"בחר אלמנט אחר\"},\"assistant_preview\":{\"message\":\"תצוגה מקדימה\"},\"assistant_block\":{\"message\":\"חסום\"},\"assistant_settings\":{\"message\":\"הגדרות העוזר האישי\"},\"assistant_preview_header\":{\"message\":\"תצוגה מקדימה - חסימת אלמנט\"},\"assistant_preview_header_info\":{\"message\":\"ודא כי אלמנט זה חסום בכוונה\"},\"assistant_preview_end\":{\"message\":\"צא מתצוגה מקדימה\"},\"wot_unknown_description\":{\"message\":\"מוניטין אינו מוגדר\"},\"wot_bad_description\":{\"message\":\"לאתר זה יש מוניטין רע מאוד על פי\"},\"wot_poor_description\":{\"message\":\"לאתר זה יש מוניטין רע על פי\"},\"wot_unsatisfactory_description\":{\"message\":\"לאתר זה יש מוניטין דל על פי\"},\"wot_good_description\":{\"message\":\"לאתר זה יש מוניטין טוב על פי\"},\"wot_excellent_description\":{\"message\":\"לאתר זה יש מוניטין מעולה על פי\"},\"settings_choose_size_and_position\":{\"message\":\"התאם גודל ומיקום של העוזר האישי של אדגארד\"},\"settings_icon_size\":{\"message\":\":גודל צלמית\"},\"settings_small\":{\"message\":\"קטן\"},\"settings_big\":{\"message\":\"גדול\"},\"settings_position\":{\"message\":\":מיקום\"},\"settings_left_top\":{\"message\":\"בחלק העליון משמאל\"},\"settings_right_top\":{\"message\":\"בחלק העליון מימין\"},\"settings_left_bottom\":{\"message\":\"צד שמאל למטה\"},\"settings_right_bottom\":{\"message\":\"צד ימין למטה\"},\"settings_cancel\":{\"message\":\"בטל\"},\"settings_save\":{\"message\":\"שמור שינויים\"}}");
        ...
        /***/ (function (module) {
            ...
            module.exports = JSON.parse("{\"settings_position_save\":\"Spletne strani\",\"settings_position_save_all\":\"Vse pletne strani\",\"settings_position_save_this\":\"To spletno stran\",\"assistant_select_element_start\":\"Začni\",\"assistant_select_element_text\":\"Izberite element na strani, ki jo želite blokirati. Osvežite stran, da prekličete način blokiranja elementa.\",\"menu_filtration_status\":{\"message\":\"Filtriranje na tej spletni strani\"},\"menu_do_not_filter_30_sec\":{\"message\":\"Ne filtriraj 30 sekund\"},\"menu_block_ad_on_site\":{\"message\":\"Blokiraj oglas na tej spletni strani\"},\"menu_report_abuse\":{\"message\":\"Prijavi spletno stran\"},\"menu_site_report\":{\"message\":\"Poročilo o varnosti spletne strani\"},\"menu_settings\":{\"message\":\"Nastavitve Pomočnika\"},\"menu_wot_reputation_indicator\":{\"message\":\"Kazalnik ugleda spletnestrani\"},\"menu_wot_reputation_confidence_level\":{\"message\":\"Raven ugleda zaupanja\"},\"assistant_select_element\":{\"message\":\"Blokiranje elementa\"},\"assistant_select_element_ext\":{\"message\":\"Izberite element na strani, ki jo želite blokirati\"},\"assistant_select_element_cancel\":{\"message\":\"Prekliči\"},\"assistant_block_element\":{\"message\":\"Blokiranje elementa\"},\"assistant_block_element_explain\":{\"message\":\"Prilagodite pravilo za blokiranju elementa\"},\"assistant_slider_explain\":{\"message\":\"Premaknite drsnik, da spremenite velikost okvirja, za katerega bo delovalo novo pravilo:\"},\"assistant_slider_min\":{\"message\":\"NAJM\"},\"assistant_slider_max\":{\"message\":\"NAJV\"},\"assistant_extended_settings\":{\"message\":\"Napredne nastavitve\"},\"assistant_apply_rule_to_all_sites\":{\"message\":\"Uporabi pravilo za vse spletne strani\"},\"assistant_block_by_reference\":{\"message\":\"Blokiraj z napotitveno povezavo\"},\"assistant_block_similar\":{\"message\":\"Blokiraj podobno\"},\"assistant_another_element\":{\"message\":\"Izberi drug element\"},\"assistant_preview\":{\"message\":\"Predogled\"},\"assistant_block\":{\"message\":\"Blokiraj\"},\"assistant_settings\":{\"message\":\"Nastavitve Pomočnika\"},\"assistant_preview_header\":{\"message\":\"Blokiranje elementa - predogled\"},\"assistant_preview_header_info\":{\"message\":\"Poskrbi, da je element blokiran, kot je bilo predvideno\"},\"assistant_preview_end\":{\"message\":\"Zapusti predogled\"},\"wot_unknown_description\":{\"message\":\"Ugled te spletne strani ni opredeljen z $1\"},\"wot_bad_description\":{\"message\":\"Ta spletna stran ima zelo slab ugled\\nglede na $1\"},\"wot_poor_description\":{\"message\":\"Ta spletna stran ima slab ugled\\nglede na $1\"},\"wot_unsatisfactory_description\":{\"message\":\"Ta spletna stran ima zelo slab ugled\\nglede na $1\"},\"wot_good_description\":{\"message\":\"Ta spletna stran ima dober ugled\\nglede na $1\"},\"wot_excellent_description\":{\"message\":\"Ta spletna stran ima odličen ugled\\nglede na $1\"},\"settings_choose_size_and_position\":{\"message\":\"Prilagodi velikost in položaj AdGuard Pomočnika\"},\"settings_icon_size\":{\"message\":\"Velikost ikone:\"},\"settings_small\":{\"message\":\"Majhna\"},\"settings_big\":{\"message\":\"Velika\"},\"settings_position\":{\"message\":\"Položaj:\"},\"settings_left_top\":{\"message\":\"Zgoraj levo\"},\"settings_right_top\":{\"message\":\"Zgoraj desno\"},\"settings_left_bottom\":{\"message\":\"Spodaj levo\"},\"settings_right_bottom\":{\"message\":\"Spodaj desno\"},\"settings_cancel\":{\"message\":\"Prekliči\"},\"settings_save\":{\"message\":\"Shrani nastavitve\"}}");
        ...
        /***/ (function (module) {
            ...
            module.exports = JSON.parse("{\"a\":\"4.3.21\"}");
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            var ___CSS_LOADER_URL___0___ = getUrl(__webpack_require__(2));
            // Module
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            var getUrl = __webpack_require__(1);
            var ___CSS_LOADER_URL___0___ = getUrl(__webpack_require__(2));
            var ___CSS_LOADER_URL___1___ = getUrl(__webpack_require__(64));
            var ___CSS_LOADER_URL___2___ = getUrl(__webpack_require__(65));
            var ___CSS_LOADER_URL___3___ = getUrl(__webpack_require__(66));
            var ___CSS_LOADER_URL___4___ = getUrl(__webpack_require__(67));
            var ___CSS_LOADER_URL___5___ = getUrl(__webpack_require__(68));
            var ___CSS_LOADER_URL___6___ = getUrl(__webpack_require__(69));
            var ___CSS_LOADER_URL___7___ = getUrl(__webpack_require__(70));
            // Module
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony default export */
            var src_protectedApi = (protectedApi);
            ...
            function upgradeHelper_classCallCheck(instance, Constructor) {
                if (!(instance instanceof Constructor)) {
                    throw new TypeError("Cannot call a class as a function");
                }
            }

            function upgradeHelper_defineProperties(target, props) {
                for (var i = 0; i < props.length; i++) {
                    var descriptor = props[i];
                    descriptor.enumerable = descriptor.enumerable || false;
                    descriptor.configurable = true;
            ...
            function upgradeHelper_createClass(Constructor, protoProps, staticProps) {
                if (protoProps) upgradeHelper_defineProperties(Constructor.prototype, protoProps);
                if (staticProps) upgradeHelper_defineProperties(Constructor, staticProps);
                return Constructor;
            }
            ...
            var upgradeHelper_UpgradeHelper =
                /*#__PURE__*/
                function () {
            ...
            /* harmony default export */
            var src_upgradeHelper = (upgradeHelper);
            // CONCATENATED MODULE: ./src/gm.js
            /* harmony default export */
            var gm = ({});

            // CONCATENATED MODULE: ./src/settings.js
            function settings_typeof(obj) {
                if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") {
                    settings_typeof = function _typeof(obj) {
                        return typeof obj;
                    };
                } else {
                    settings_typeof = function _typeof(obj) {
            ...
            var templates_button = __webpack_require__(3);
            ...
            var mobile_style = __webpack_require__(15);
            ...
            // EXTERNAL MODULE: ./locales/ar/messages.json
            var messages = __webpack_require__(16);

            // EXTERNAL MODULE: ./locales/be/messages.json
            var be_messages = __webpack_require__(17);

            // EXTERNAL MODULE: ./locales/cs/messages.json
            var cs_messages = __webpack_require__(18);

            // EXTERNAL MODULE: ./locales/da/messages.json
            var da_messages = __webpack_require__(19);

            // EXTERNAL MODULE: ./locales/de/messages.json
            var de_messages = __webpack_require__(20);

            // EXTERNAL MODULE: ./locales/en/messages.json
            var en_messages = __webpack_require__(21);

            // EXTERNAL MODULE: ./locales/es/messages.json
            var es_messages = __webpack_require__(22);

            // EXTERNAL MODULE: ./locales/fa/messages.json
            var fa_messages = __webpack_require__(23);

            // EXTERNAL MODULE: ./locales/fr/messages.json
            var fr_messages = __webpack_require__(24);

            // EXTERNAL MODULE: ./locales/he/messages.json
            var he_messages = __webpack_require__(25);

            // EXTERNAL MODULE: ./locales/id/messages.json
            var id_messages = __webpack_require__(26);

            // EXTERNAL MODULE: ./locales/it/messages.json
            var it_messages = __webpack_require__(27);

            // EXTERNAL MODULE: ./locales/ja/messages.json
            var ja_messages = __webpack_require__(28);

            // EXTERNAL MODULE: ./locales/ko/messages.json
            var ko_messages = __webpack_require__(29);

            // EXTERNAL MODULE: ./locales/no/messages.json
            var no_messages = __webpack_require__(30);

            // EXTERNAL MODULE: ./locales/pl/messages.json
            var pl_messages = __webpack_require__(31);

            // EXTERNAL MODULE: ./locales/pt/messages.json
            var pt_messages = __webpack_require__(32);

            // EXTERNAL MODULE: ./locales/pt-PT/messages.json
            var pt_PT_messages = __webpack_require__(33);

            // EXTERNAL MODULE: ./locales/ru/messages.json
            var ru_messages = __webpack_require__(34);

            // EXTERNAL MODULE: ./locales/sk/messages.json
            var sk_messages = __webpack_require__(35);

            // EXTERNAL MODULE: ./locales/sl/messages.json
            var sl_messages = __webpack_require__(36);

            // EXTERNAL MODULE: ./locales/sr/messages.json
            var sr_messages = __webpack_require__(37);

            // EXTERNAL MODULE: ./locales/sv/messages.json
            var sv_messages = __webpack_require__(38);

            // EXTERNAL MODULE: ./locales/tr/messages.json
            var tr_messages = __webpack_require__(39);

            // EXTERNAL MODULE: ./locales/uk/messages.json
            var uk_messages = __webpack_require__(40);

            // EXTERNAL MODULE: ./locales/zh/messages.json
            var zh_messages = __webpack_require__(41);
            ...
            /* harmony default export */
            var locales_0 = (locales);

            // CONCATENATED MODULE: ./src/localization.js
            function localization_typeof(obj) {
                if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") {
                    localization_typeof = function _typeof(obj) {
                        return typeof obj;
                    };
                } else {
                    localization_typeof = function _typeof(obj) {
                ...
                return localization_typeof(obj);
            }
       ...
       */
            ...
            /* harmony default export */
            var src_localization = (localization);
       ...
       */
            ...
            function adguard_selector_typeof(obj) {
                if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") {
                    adguard_selector_typeof = function _typeof(obj) {
                        return typeof obj;
                    };
                } else {
                    adguard_selector_typeof = function _typeof(obj) {
                ...
                return adguard_selector_typeof(obj);
            }
            ...
            /* harmony default export */
            var adguard_selector = (adguard_selector_selector);
       ...
       */
            ...
            /* harmony default export */
            var slider_widget = (sliderWidget);
            ...
            /* harmony default export */
            var adguard_rules_constructor = (adguardRulesConstructor);
       ...
       */
            ...
            /* harmony default export */
            var ui_validation_utils = (uiValidationUtils);
    ...
    `*  setAnchorPosition: Function,
       ...
       */
            ...
            /* harmony default export */
            var src_iframe = (IframeController);
       ...
       */
            ...
            var package_0 = __webpack_require__(43);

            // CONCATENATED MODULE: ./src/iframe.mobile.js
            function iframe_mobile_ownKeys(object, enumerableOnly) {
                var keys = Object.keys(object);
                if (Object.getOwnPropertySymbols) {
                    var symbols = Object.getOwnPropertySymbols(object);
                    if (enumerableOnly) symbols = symbols.filter(function (sym) {
            ...
            function iframe_mobile_objectSpread(target) {
                for (var i = 1; i < arguments.length; i++) {
                    var source = arguments[i] != null ? arguments[i] : {};
                    if (i % 2) {
                        iframe_mobile_ownKeys(source, true).forEach(function (key) {
                            iframe_mobile_defineProperty(target, key, source[key]);
                        });
                    } else if (Object.getOwnPropertyDescriptors) {
                        Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));
                    } else {
                        iframe_mobile_ownKeys(source).forEach(function (key) {
                            Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));
                        });
                    }
                }
            ...
            function iframe_mobile_defineProperty(obj, key, value) {
                if (key in obj) {
                    Object.defineProperty(obj, key, {
                        value: value,
                        enumerable: true,
